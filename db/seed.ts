...
const communitiesData = [
  ...
  name: "Meetsy Learners Hub",
  description:
    "A collaborative community for learners to share knowledge, improve coding skills, and grow their tech careers together",
},
...
const learningGoalsData = {
 ...
 "Meetsy Learners Hub": [
  ...
  },
  {
    ...
    description: "Learn how to build an online presence and share your knowledge effectively",
  },
],
...
async function comprehensiveSeed() {
  ...
  try {
    ...
    console.log("\n💡 YOUR ACCOUNTS (PRO):");
    console.log("   • rimjhim@gmail.com");
    console.log("   • anaya@gmail.com");
    console.log("\n💡 OTHER TEST ACCOUNTS:");
