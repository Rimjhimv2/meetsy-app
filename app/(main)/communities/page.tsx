...
//   // Automatically join the first community if not joined
//   useEffect(() => {
//     if (!communities || !user) return;
//     const firstCommunity = communities[0];
//     setSelectedCommunity(firstCommunity.community.id);

//     if (!firstCommunity.joined) {
//       joinCommunityMutation.mutateAsync(firstCommunity.community.id)
//         .then(() => toast.success("Joined community successfully"))
