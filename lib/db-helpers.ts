// import { db } from "@/db";
// import { communityMembers, learningGoals, matches, users, conversations,  } from "@/db/schema";
...
//         eq(matches.communityId, communityId),
//         sql`(
//           (${matches.user1Id} = ${user1Id} AND ${matches.user2Id} = ${user2Id})
//           OR
//           (${matches.user1Id} = ${user2Id} AND ${matches.user2Id} = ${user1Id})
//         )`
//       )
//     )
//     .limit(1);
