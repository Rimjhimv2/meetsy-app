...
//   // 🔥 FALLBACK: AI fail ho jaye to bhi matches bano
//   matchIndices = potentialPartners
//     .slice(0, 3)
//     .map((_, idx) => idx + 1);

//   console.log("Fallback match indices:", matchIndices);
// }
//   };
